...
public class Mall
{
	public Mall()
	{
		JFrame frame3 = new JFrame("Shopping Mall");
		...
		JLabel jLabel3 = new JLabel("Weekend you can enjoy with Shopping :) ");
		JLabel jLabel4 = new JLabel("So, Click any of the two choices to know Shooping Mall ");
		...
		JLabel jLabel5 = new JLabel("Phoenix Marketcity");
		JLabel jLabel6 = new JLabel("Express Avenue");
		JLabel jLabel7 = new JLabel("Forum Mall");
		JLabel jLabel8 = new JLabel("VR Chennai");
		JLabel jLabel9 = new JLabel("Palladium");
		
		JLabel jLabel10 = new JLabel("Brookefields");
		JLabel jLabel11 = new JLabel("Fun Republic Mall");
		JLabel jLabel12 = new JLabel("Unitea Mall");
		JLabel jLabel13 = new JLabel("Prozone Mall");
		JLabel jLabel14 = new JLabel("EX Avenue");
		
		JLabel jLabel15 = new JLabel("MILAN'EM MALL");
		JLabel jLabel16 = new JLabel("City Center Madurai");
		JLabel jLabel17 = new JLabel("London Mall");
		JLabel jLabel18 = new JLabel("Max Fashion");
		JLabel jLabel19 = new JLabel("Vishaal de Mal");

		JLabel jLabel20 = new JLabel("Note:-");
		JLabel jLabel21 = new JLabel("just for our convice ");
